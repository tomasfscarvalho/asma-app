  ...
  return (
    <Layout
      ...
      resumo={[
        ...
        { key: 'Abuso de SABA', val: fase5.abusoDeSaba ? 'Sim' : 'Não' },
      ]}
    >
      ...
      <div style={{ padding: 20, minHeight: 280 }}>
        <div style={{ marginBottom: 16, background: '#0F6E5620', border: '1px solid #1D9E7530', borderRadius: 6, padding: '10px 12px' }}>
          <p style={{ color: '#9FE1CB', fontSize: 12, margin: 0 }}>
            A avaliação do risco futuro complementa a avaliação do controlo da asma realizada na Fase 4 e deve ser interpretada em conjunto.
          </p>
        </div>
        ...
        {step === 0 && (
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <CheckItem
                label="Intubação ou internamento prévio em UCI por asma"
            ...
            <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                ...
                <input
                  ...
                  placeholder="Número de agudizações"
